            ...
            <div class="w-full h-screen flex justify-center items-center ">
                <div class=" glass w-80 h-auto bg-white">
                    ...
                    <form action="{{route('login')}}" method="post">
                        ...
                        <div class="py-2 mx-6">
                            <input type="password" class="rounded-lg  shadow-lg border border-transparent focus:ring-gray-200 w-full  focus:border-gray-600" name="password" placeholder="Enter Password">
                        </div>

                        <div class="py-2 mx-6">
                            <a href="{{route('password.request')}}" class="text-sm hover:text-gray-400 text-gray-600">Forget Password?</a>
                        </div>
                        

                        <div class="flex justify-center mt-2 mb-6">
                            <input type="submit" value="Login" class="px-8 py-2 bg-gray-500 rounded-full text-white hover:bg-gray-700 cursor-pointer">
                        </div>
                    </form>
                </div>
            </div>
