    ...
    <body>
        ...
        <div class="  h-screen w-full">
            <div class="w-full h-screen flex justify-center items-center ">
                <div class=" glass w-96 h-auto bg-white">
                    ...
                    <form action="{{route('password.email')}}" method="post">
                        ...
                        @endforeach
                        <div class="my-2 pb-2 mx-6">
                            <p class="px-1 text-gray-400">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</p>
                        </div>
    
                        <div class="py-2 mx-6">
                            <input type="email" class="rounded-lg  shadow-lg border border-transparent focus:ring-gray-200 w-full  focus:border-gray-600" name="email" placeholder="Enter Email address">
                        </div>

                        

                        <div class="flex justify-center mt-2 mb-6">
                            <input type="submit" value="Email Password Reset Link" class="px-8 py-2 bg-gray-500 rounded-full text-white hover:bg-gray-700 cursor-pointer">
                        </div>
                    </form>
                </div>
            </div>
