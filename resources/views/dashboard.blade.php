    ...
    @if (Auth::user()->role != "admin")
        ...
        <div class="grid grid-cols-4 gap-10">
            <div class="col-span-3 mt-5">
                <div class="grid grid-cols-2 gap-5"> 
                    <div class="w-full h-32 bg-emerald-500 rounded-lg shadow-md shadow-emerald-200 my-1 ">
                    ...
                    <div class="w-full h-32 bg-amber-500 rounded-lg shadow-md shadow-amber-200 my-1">
                        <h1 class="text-white font-bold text-xl pt-4 px-4">
                            Early Exit
                        </h1>
                        <div class="flex justify-between my-2">
            ...
            <div class=" my-1">
                <div id="np_widget_wiz1" widget="day-sm" class="w-full my-5"></div> 
                        <script async src="https://nepalipatro.com.np/np-widgets/nepalipatro.js" id="wiz1"></script>
                <div id="np_widget_wiz2" widget="holidays" class="h-8" ></div> 
        ...
        <div class="grid grid-cols-3  gap-5">
            <div class="col-span-2 mt-5">
                <div class="grid grid-cols-2 gap-10 my-1 mr-6"> 
            ...
            if("{{Auth::user()->entry_time}}" < "{{Carbon\Carbon::now()->format('H:i:m')}}") {
                console.log('ima');
                    ...
                    $('#submit').click(function (e) {
                        ...
                        $('#reason_box').removeClass('flex');
                        $('#reason_box').addClass('hidden');
                        if($("#reason").val()[0] == ' '|| $("#reason").val() ==''){
                            $('#message').toggle('hidden');
                            $('#message_text').html('Enter Valid Reason');
                            return;
                        }
                        $.ajax({
                            type: 'POST',
